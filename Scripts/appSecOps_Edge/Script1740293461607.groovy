...
WebUI.setText(findTestObject('Page_AppSecOps/Page_Login/loginUsername'), 'automatetestlab@intrucept.com')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_BusinessUnit/input_Business Unit Name'), 'NewBusinessUnit')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_AssetGroup/input_Asset Group Name'), 'NewAssetGroup')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_User/input_First Name'), 'New First')

WebUI.setText(findTestObject('Page_AppSecOps/Page_User/input_Last Name'), 'New Last')

WebUI.setText(findTestObject('Page_AppSecOps/Page_User/input_Email'), 'intrucept_new@gmail.com')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_User/input_Phone Number'), '9087654300')

WebUI.selectOptionByLabel(findTestObject('Page_AppSecOps/Page_User/select_Business Unit'), 'NewBusinessUnit', false)

WebUI.setText(findTestObject('Page_AppSecOps/Page_User/input_Location'), 'New Location')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_Application/input_Application Name'), 'Mobile Application')

WebUI.selectOptionByIndex(findTestObject('Page_AppSecOps/Page_Application/select_Applicationtype'), 3)

WebUI.selectOptionByLabel(findTestObject('Page_AppSecOps/Page_Application/select_BusinessUnit'), 'NewBusinessUnit', false)

WebUI.selectOptionByLabel(findTestObject('Page_AppSecOps/Page_Application/select_AssetGroup'), 'NewAssetGroup', false)

WebUI.selectOptionByIndex(findTestObject('Page_AppSecOps/Page_Application/select_BusinessOwner'), 1)

WebUI.selectOptionByLabel(findTestObject('Page_AppSecOps/Page_Application/select_BusinessImpact'), 'MEDIUM', false)

WebUI.scrollToElement(findTestObject('Page_AppSecOps/Page_Application/button_Save Application'), 5)

WebUI.setText(findTestObject('Page_AppSecOps/Page_Application/textarea_Description'), 'Test Description Edge')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_SAST Scan/input_Scan Name'), 'SAST vulpy python')

WebUI.selectOptionByLabel(findTestObject('Page_AppSecOps/Page_SAST Scan/select_Select Application'), 'Mobile Application', 
    false)

WebUI.uploadFile(findTestObject('Page_AppSecOps/Page_SAST Scan/input_Upload the project zip'), 'C:\\Users\\Intru009\\Desktop\\Intrucept\\Intrucept\\POC\\ASOscanfiles\\vulpy-Python-main.zip')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_SCA Scan/input_Scan Name'), 'SCA_Onlinebookstore_Java')

WebUI.selectOptionByLabel(findTestObject('Page_AppSecOps/Page_SCA Scan/select_select Application'), 'Mobile Application', 
    false)

WebUI.uploadFile(findTestObject('Page_AppSecOps/Page_SCA Scan/input_Upload the project zip'), 'C:\\Users\\Intru009\\Desktop\\Intrucept\\Intrucept\\OneDrive_2024-12-04\\sast TEST APP\\SAST\\java\\onlinebookstore-master\\onlinebookstore-master.zip')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_Ticket/input__Ticket title'), 'Manual Ticket Edge')

WebUI.selectOptionByIndex(findTestObject('Page_AppSecOps/Page_Ticket/select_Ticket category'), 2)

WebUI.selectOptionByLabel(findTestObject('Page_AppSecOps/Page_Ticket/select_Priority'), 'Critical', false)

WebUI.setText(findTestObject('Page_AppSecOps/Page_Ticket/textarea_Description'), 'Edge Manual ticket description')
...
WebUI.setText(findTestObject('Page_AppSecOps/Page_Ticket/textarea_Note'), 'Edge Automation Notes')
